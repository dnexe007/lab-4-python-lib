...
def test_empty_collection() -> None:
    """Test initialization and representation of empty collection."""
...
def test_collection_with_initial_games() -> None:
    """Test collection initialization with existing games."""
...
def test_add_game() -> None:
    """Test adding a single game to collection."""
    collection = GameCollection()
...
def test_add_multiple_games() -> None:
    """Test adding multiple distinct games to collection."""
    collection = GameCollection()
...
def test_remove_game() -> None:
    """Test removing existing game from collection."""
    collection = GameCollection()
    game = GAMES_DATABASE[0]
...
def test_remove_nonexistent_game() -> None:
    """Test removing non-existent game raises ValueError."""
    collection = GameCollection()
...
def test_index() -> None:
    """Test finding index of games in collection."""
    collection = GameCollection()
    game1 = GAMES_DATABASE[0]
    game2 = GAMES_DATABASE[1]
...
def test_getitem() -> None:
    """Test accessing games by index using [] operator."""
    collection = GameCollection()
    game1 = GAMES_DATABASE[0]
    game2 = GAMES_DATABASE[1]
...
def test_iteration() -> None:
    """Test iteration over collection yields all games."""
    collection = GameCollection()
...
def test_clear() -> None:
    """Test clearing all games from collection."""
    collection = GameCollection()
...
def test_game_type_decorator_wrong_type() -> None:
    """Test type checking decorator prevents non-Game objects."""
    collection = GameCollection()
...
def test_contains_with_wrong_type() -> None:
    """Test __contains__ raises TypeError for non-Game objects."""
    collection = GameCollection()
...
def test_repr_content() -> None:
    """Test string representation includes game details."""
    collection = GameCollection()
    game = GAMES_DATABASE[0]
...
def test_duplicate_games() -> None:
    """Test adding duplicate game objects is allowed."""
    collection = GameCollection()
    game = GAMES_DATABASE[0]
...
def test_initial_empty_collection() -> None:
    """Test default initialization creates empty collection."""
    collection = GameCollection()
    assert len(collection) == 0
    assert repr(collection) == "GameCollection([])"
...
def test_game_type_decorator_with_none() -> None:
    """Test type checking prevents None objects."""
    collection = GameCollection()
...
def test_collection_as_iterable() -> None:
    """Test collection can be used in for loops."""
    collection = GameCollection()
    games = [GAMES_DATABASE[0], GAMES_DATABASE[1], GAMES_DATABASE[2]]
